...
pub use archive::{
    ...
    CompressMethod, CreateWriteStats, HeaderFile, MemberIndex, MemberIndexEntry,
    NonsolidLzma2Writer, NonsolidStoreWriter, TarMemberIndex, TarMemberIndexEntry, SIG_HEADER_SIZE,
};
...
pub use select::{
    ...
    load_dir_max_files_from, load_dir_max_size_from, load_exclude_from, load_file_size_from,
    load_filter_from, load_include_from, meta_owner_mode, names_for_uid_gid, parse_dir_budgets,
    parse_dir_file_limits, parse_dir_max_files_arg, parse_dir_max_size_arg, parse_dir_restrict_line,
    parse_duration_secs, parse_file_size_line, parse_rule, per_file_limits_from_cli, DirBudget,
    DirBudgetOutcome, DirFileLimit, DirFileLimitOutcome, FileSizeRule, GlobalCountCapOutcome,
    GlobalSizeCapOutcome, MemberKind, PerFileLimits, RestrictionFile, RestrictionReport, Rule,
    RuleAction, RuleSet, SelectedEntry, SelectionStats, SourceKind, SourceSpec, DEFAULT_FILE_MODE,
};
